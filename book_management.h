...
#define MaxBooks 400
extern FILE *p;
extern struct Book *books[MaxBooks];
extern struct BookArray *bA[3];
extern int numBooks;
extern char title[40];
extern char authors[40];
extern int year;
extern int copies;
extern int titleCounter;

struct Book {
    int id; //id of the book (1st column in each row in the text file)
